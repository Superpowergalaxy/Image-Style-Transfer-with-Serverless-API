...
Original file is located at
    https://colab.research.google.com/drive/12q45ydEvHaneBnRkWnOebJHvPH9NE9Bp
...
imize a given loss with respect to input parameters
...
if not os.path.exists(img_dir):
    os.makedirs(img_dir)https://upload.wikimedia.org/wikipedia/commons/d/d7/Green_Sea_Turtle_grazing_seagrass.jpg
os.system('wget --quiet -P /tmp/nst/' )
os.system('wget --quiet -P /tmp/nst/ https://upload.wikimedia.org/wikipedia/commons/0/0a/The_Great_Wave_off_Kanagawa.jpg' )
os.system('wget --quiet -P /tmp/nst/ https://upload.wikimedia.org/wikipedia/commons/b/b4/Vassily_Kandinsky%2C_1913_-_Composition_7.jpg' )
os.system('wget --quiet -P /tmp/nst/ https://upload.wikimedia.org/wikipedia/commons/0/00/Tuebingen_Neckarfront.jpg' )
os.system('wget --quiet -P /tmp/nst/ https://upload.wikimedia.org/wikipedia/commons/6/68/Pillars_of_creation_2014_HST_WFC3-UVIS_full-res_denoised.jpg' )
os.system('wget --quiet -P /tmp/nst/ https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg/1024px-Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg' )
os.system('mkdir/tmp/result')
...
def show_results(best_img, content_path, style_path, image_name, show_large_final=True):
  ...
  if show_large_final: 
    ...
    plt.savefig('/tmp/result/'+image_name)
...
"""
# get sqs and S3 resourse
def get_resource(ACCESS_ID,ACCESS_KEY):
  ...
  return s3_client, sqs_client, sqs_queue_url
s3_client, sqs_client, sqs_queue_url = get_resource(ACCESS_ID,ACCESS_KEY)


# main loop to read the sqs queue and keep processing the comming image
while True:
  ...
  try: 
    for message in messages['Messages']: # 'Messages' is a list
      ...
      s3_client.download_file('image-style-transfer-jingyu', image_name, image_name)

      best_starry_night, best_loss = run_style_transfer(image_name,
      '/tmp/nst/1024px-Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg')

      show_results(best_starry_night, image_name, 
      '/tmp/nst/1024px-Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg',image_name)
